const VOCAB = [
  ...
  {w:"learn to",t:"навчитися",e:"He taught her to swim.",topic:"Дієслова + інфінітив"},
  // Дієслова загальні
...
const SENTENCES = [
  {ru:"Я думаю, що буду на роботі о 8 і не запізнюся.",en:"I think I will be at work by 8 and I won't be late.",set:"Set 1"},
  {ru:"Ніхто не сумує за ним, бо ніхто його не любить.",en:"Nobody misses him because nobody likes him.",set:"Set 1"},
  {ru:"Він хотів би бути тут, і він хотів би нам допомогти.",en:"He would like to be here and he would like to help us.",set:"Set 1"},
  {ru:"Вона б не хотіла знати забагато, але хотіла б бути розумною.",en:"She wouldn't like to know too much but she would like to be smart.",set:"Set 1"},
  {ru:"Мені б не хотілося тебе бачити, бо ти мені не подобаєшся.",en:"I wouldn't like to see you because I don't like you.",set:"Set 1"},
  {ru:"Мій приятель часто дивився на свою сусідку і захоплювався нею.",en:"My friend often looked at his neighbour and admired her.",set:"Set 1"},
  {ru:"Ніхто ніколи не буде посміхатися і підморгувати їй на уроці.",en:"Nobody will ever smile and wink at her during the lesson.",set:"Set 1"},
  {ru:"Вона була надто зарозуміла і ніколи нікому не посміхалася.",en:"She was too arrogant and never smiled at anyone.",set:"Set 2"},
  {ru:"Ми розчаровані у вас, тому ми б не хотіли дотримуватися ваших інструкцій.",en:"We are disappointed in you, so we wouldn't like to follow your instructions.",set:"Set 2"},
  {ru:"У неї не було необхідного досвіду, тому її не найняли.",en:"She didn't have the necessary experience, so they didn't hire her.",set:"Set 2"},
  {ru:"Він захоплюється нею за її красу і доброту, крім того він пишається нею.",en:"He admires her for her beauty and kindness, besides he is proud of her.",set:"Set 2"},
  {ru:"Я покарав їх за лицемірство, тому вони мене ненавидять.",en:"I punished them for their hypocrisy, so they hate me.",set:"Set 2"},
  {ru:"Він відмовиться допомагати їй, бо вона надто егоїстична.",en:"He will refuse to help her because she is too selfish.",set:"Set 2"},
  {ru:"Я не звинувачую вас у легковажності. Справа в тому, що вам бракує терпіння.",en:"I don't blame you for your frivolity. The matter is that you don't have enough patience.",set:"Set 2"},
  {ru:"Відверто кажучи, я не був готовий до цього, тому мене дратував його дзвінок.",en:"Frankly speaking, I was not ready for it, so I was annoyed by his call.",set:"Set 2"},
  {ru:"Вона забула йому відповісти, бо була дуже зайнята.",en:"She forgot to answer him because she was very busy.",set:"Set 3"},
  {ru:"У нього більше нема терпіння — він надто розчарований у ній.",en:"He has no patience left — he is too disappointed in her.",set:"Set 3"},
  {ru:"Я розраховую на вас. Всі кажуть, що ви дуже відповідальна людина.",en:"I count on you. Everyone says you are a very responsible person.",set:"Set 3"},
  {ru:"Ніхто ніколи не скаржиться на свою роботу, бо всі дуже успішні.",en:"Nobody ever complains about their work because everyone is very successful.",set:"Set 3"},
  {ru:"Подруга моєї мами відмовилася купувати нову машину своєму синові, бо він лінивий.",en:"My mother's friend refused to buy her son a new car because he is lazy.",set:"Set 3"},
  {ru:"Вони відмовлять йому, бо в нього не буде жодного доказу.",en:"They will refuse him because he won't have a single piece of evidence.",set:"Set 4"},
  {ru:"Всі витріщилися на нього, бо на ньому був новий костюм.",en:"Everyone stared at him because he was wearing a new suit.",set:"Set 4"},
  {ru:"Він був дуже схвильований щодо майбутньої зустрічі.",en:"He was very excited about the upcoming meeting.",set:"Set 4"},
  {ru:"У всіх було багато часу, щоб підготуватися.",en:"Everyone had plenty of time in order to prepare.",set:"Set 4"},
  {ru:"У дитинстві вона і співала, і танцювала добре, тому стала відомою співачкою.",en:"As a child she both sang and danced well, so she became a famous singer.",set:"Set 5"},
  {ru:"Він не тільки відповідальний, але й порядний, тому всі його поважають.",en:"He is not only responsible but also decent, so everyone respects him.",set:"Set 5"},
  {ru:"У них немає ні роботи, ні грошей, бо вони надто самовдоволені.",en:"They have neither a job nor money because they are too conceited.",set:"Set 5"},
  {ru:"Завдяки йому вона їсть мало хліба. Справа в тому, що вона закохалася в нього.",en:"Thanks to him she eats little bread. The matter is that she fell in love with him.",set:"Set 5"},
  {ru:"Я погано виходжу на фотографіях. Вона теж.",en:"I don't look good in photos. Neither does she.",set:"Set 6"},
  {ru:"Вона не готова сьогодні. Ми теж. Вчора ми добре провели час — ми і співали, і танцювали.",en:"She is not ready today. Neither are we. Yesterday we had a great time — we both sang and danced.",set:"Set 6"},
  {ru:"Вона завжди робить нотатки під час лекції. Ми теж. А він не робить.",en:"She always takes notes during the lecture. So do we. But he doesn't.",set:"Set 6"},
  {ru:"Вона часто порівнює його зі своїм другом, хоча йому це не подобається. Мені теж.",en:"She often compares him to her friend, although he doesn't like it. Neither do I.",set:"Set 6"},
  {ru:"З одного боку, він звинуватив її у своїх проблемах, але з іншого боку вона завжди була добра до нього.",en:"On the one hand he blamed her for his problems, but on the other hand she was always kind to him.",set:"Set 6"},
  {ru:"In order to get up early he set the alarm.",en:"Щоб встати рано, він поставив будильник.",set:"Практика конструкцій"},
  {ru:"In order not to be late she took a taxi.",en:"Щоб не запізнитися, вона взяла таксі.",set:"Практика конструкцій"},
  {ru:"She decided to go in order to save money.",en:"Вона вирішила піти, щоб заощадити гроші.",set:"Практика конструкцій"},
  {ru:"I like the way she teaches English.",en:"Мені подобається, як вона викладає англійську.",set:"Практика конструкцій"},
  {ru:"Do you know how to drive?",en:"Ти вмієш водити машину?",set:"Практика конструкцій"},
  {ru:"Why did he fail to help?",en:"Чому йому не вдалося допомогти?",set:"Практика конструкцій"},
  {ru:"She managed to get a day off.",en:"Їй вдалося взяти вихідний.",set:"Практика конструкцій"},
  {ru:"Is she going to have a date?",en:"Вона збирається на побачення?",set:"IT інтерв'ю"},
  {ru:"Why did you choose to work in IT?",en:"Чому ви обрали роботу в IT?",set:"IT інтерв'ю"},
  {ru:"What are your current responsibilities?",en:"Які ваші поточні обов'язки?",set:"IT інтерв'ю"},
  {ru:"Are you trying to learn anything new at the moment?",en:"Ви зараз намагаєтеся чомусь навчитися?",set:"IT інтерв'ю"},
  {ru:"Where do you see yourself in the future?",en:"Ким ви бачите себе в майбутньому?",set:"IT інтерв'ю"},
];
...
const QUIZ_DATA = [
  ...
  {q:"'І вона співає, і танцює добре':", opts:["Either she sings or dances","Neither she sings nor dances","Both she sings and dances","Not only she sings but also dances"], correct:2, note:"both … and … = і … і … (обидві дії виконуються). Не плутай з either/or (вибір).", topic:"Connectors"},
